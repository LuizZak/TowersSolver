...
class NetGridGeneratorTests: XCTestCase {
    ...
    func testTileFromEncoded_endPoint() throws {
        try assertTileFromEncoded(
            EncodedTileConstants.upBitcode,
            matchesKind: .endPoint,
            orientation: .north
        )
        try assertTileFromEncoded(
            EncodedTileConstants.rightBitcode,
    ...
    func testTileFromEncoded_lineTile() throws {
        try assertTileFromEncoded(
            EncodedTileConstants.upBitcode | EncodedTileConstants.downBitcode,
            matchesKind: .I,
            orientation: .north
        )
        try assertTileFromEncoded(
            EncodedTileConstants.leftBitcode | EncodedTileConstants.rightBitcode,
            matchesKind: .I,
            orientation: .east
        )
    }
...
extension NetGridGeneratorTests {
    fileprivate func assertTileFromEncoded(
        _ value: Int,
    ...
    fileprivate func assertEdgePortsFromEncoded(
        _ value: Int,
